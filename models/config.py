...
class TimeSformerMAEConfig:
    ...
    tubelet_size: int = 1  # 1 frame per temporal tube
    ...
    def __post_init__(self):
        ...
        self.num_frames_patches = self.num_frames // self.tubelet_size
        self.total_patches = self.num_frames_patches * self.num_patches_per_frame
